    ...
    return (
        <div className="relative flex w-full flex-wrap items-center justify-center bg-orange-200">
            ...
            <div className="CardsContainer mx-auto my-14 flex w-5/6 justify-center rounded-3xl border-2 border-gray-100 bg-white bg-opacity-30 py-16">
                <div
                    className="Card relative mx-4 w-1/4 origin-bottom transform overflow-hidden rounded-xl object-cover duration-500 hover:-translate-y-2 hover:rotate-3 hover:scale-110"
                ...
                <div
                    className="Card relative mx-4 w-1/4 origin-bottom transform overflow-hidden rounded-xl object-cover duration-500 hover:-translate-y-2 hover:-rotate-2 hover:scale-110"
